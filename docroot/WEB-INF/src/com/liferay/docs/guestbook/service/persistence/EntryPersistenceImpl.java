...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_GROUPID = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Entry> findByGroupId(long groupId, int start, int end)
	 ...
	 */
	@Override
	public Entry findByGroupId_First(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByGroupId_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Entry fetchByGroupId_First(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Entry> list = findByGroupId(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Entry findByGroupId_Last(long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByGroupId_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public Entry fetchByGroupId_Last(long groupId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<Entry> list = findByGroupId(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Entry[] findByGroupId_PrevAndNext(long EntryId, long groupId,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(session, entry, groupId,
					orderByComparator, true);

			array[1] = entry;

			array[2] = getByGroupId_PrevAndNext(session, entry, groupId,
	...
	protected Entry getByGroupId_PrevAndNext(Session session, Entry entry,
	...
	public void removeByGroupId(long groupId) throws SystemException {
		for (Entry entry : findByGroupId(groupId, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 = "entry.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_N_M = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByN_M",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_N_M = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByN_M",
			new String[] { String.class.getName(), String.class.getName() },
			EntryModelImpl.NAME_COLUMN_BITMASK |
			EntryModelImpl.MESSAGE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_N_M = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Entry> findByN_M(String name, String message)
		throws SystemException {
		return findByN_M(name, message, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<Entry> findByN_M(String name, String message, int start, int end)
		throws SystemException {
		return findByN_M(name, message, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Entry> findByN_M(String name, String message, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_N_M;
			finderArgs = new Object[] { name, message };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_N_M;
		...
		if ((list != null) && !list.isEmpty()) {
			for (Entry entry : list) {
				if (!Validator.equals(name, entry.getName()) ||
						!Validator.equals(message, entry.getMessage())) {
					list = null;
		...
		if (list == null) {
			...
			if (name == null) {
				query.append(_FINDER_COLUMN_N_M_NAME_1);
			}
			else if (name.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_N_M_NAME_3);
			}
			else {
				bindName = true;

				query.append(_FINDER_COLUMN_N_M_NAME_2);
			}

			boolean bindMessage = false;

			if (message == null) {
				query.append(_FINDER_COLUMN_N_M_MESSAGE_1);
			}
			else if (message.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_N_M_MESSAGE_3);
			}
			else {
				bindMessage = true;

				query.append(_FINDER_COLUMN_N_M_MESSAGE_2);
			}
	 ...
	 */
	@Override
	public Entry findByN_M_First(String name, String message,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByN_M_First(name, message, orderByComparator);
	 ...
	 */
	@Override
	public Entry fetchByN_M_First(String name, String message,
		OrderByComparator orderByComparator) throws SystemException {
		List<Entry> list = findByN_M(name, message, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public Entry findByN_M_Last(String name, String message,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByN_M_Last(name, message, orderByComparator);
	 ...
	 */
	@Override
	public Entry fetchByN_M_Last(String name, String message,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByN_M(name, message);

		if (count == 0) {
			return null;
		}

		List<Entry> list = findByN_M(name, message, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Entry[] findByN_M_PrevAndNext(long EntryId, String name,
		String message, OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = findByPrimaryKey(EntryId);
		...
		try {
			...
			array[0] = getByN_M_PrevAndNext(session, entry, name, message,
					orderByComparator, true);

			array[1] = entry;

			array[2] = getByN_M_PrevAndNext(session, entry, name, message,
					orderByComparator, false);
	...
	protected Entry getByN_M_PrevAndNext(Session session, Entry entry,
		String name, String message, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByN_M(String name, String message)
		throws SystemException {
		for (Entry entry : findByN_M(name, message, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(entry);
		}
	}
	 ...
	 */
	@Override
	public int countByN_M(String name, String message)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_N_M;

		Object[] finderArgs = new Object[] { name, message };
	...
	private static final String _FINDER_COLUMN_N_M_NAME_1 = "entry.name IS NULL AND ";
	private static final String _FINDER_COLUMN_N_M_NAME_2 = "entry.name = ? AND ";
	private static final String _FINDER_COLUMN_N_M_NAME_3 = "(entry.name IS NULL OR entry.name = '') AND ";
	private static final String _FINDER_COLUMN_N_M_MESSAGE_1 = "entry.message IS NULL";
	private static final String _FINDER_COLUMN_N_M_MESSAGE_2 = "entry.message = ?";
	private static final String _FINDER_COLUMN_N_M_MESSAGE_3 = "(entry.message IS NULL OR entry.message = '')";
	...
	public Entry updateImpl(com.liferay.docs.guestbook.model.Entry entry)
		...
		if (isNew || !EntryModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((entryModelImpl.getColumnBitmask() &
				...
				args = new Object[] { entryModelImpl.getGroupId() };
			...
			if ((entryModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_N_M.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						entryModelImpl.getOriginalName(),
						entryModelImpl.getOriginalMessage()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_N_M, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_N_M,
					args);

				args = new Object[] {
						entryModelImpl.getName(), entryModelImpl.getMessage()
					};
